...
def msdn_msoAutoShapeTypes():
    ...
    return (
        ...
        (
            ...
            124,
            "Callout with border, accent bar, and callout line segments forminga U-shape.",
        ),
        (
        ...
        ("msoShapeRound2DiagRectangle", 153, "Round Diagonal Corner Rectangle"),
        ("msoShapeRound2SameRectangle", 152, "Round Same Side Corner Rectangle"),
        ...
        ("msoShapeSnip2DiagRectangle", 157, "Snip Diagonal Corner Rectangle"),
        ("msoShapeSnip2SameRectangle", 156, "Snip Same Side Corner Rectangle"),
        ("msoShapeSnipRoundRectangle", 154, "Snip and Round Single Corner Rectangle"),
...
def prst_map():
    ...
    return (
        ...
        ("msoShapeActionButtonBeginning", "actionButtonBeginning", "Action Button: Beginning"),
        ("msoShapeActionButtonCustom", "actionButtonBlank", "Action Button: Custom"),
        ("msoShapeActionButtonDocument", "actionButtonDocument", "Action Button: Document"),
        ...
        ("msoShapeActionButtonHelp", "actionButtonHelp", "Action Button: Help"),
        ("msoShapeActionButtonHome", "actionButtonHome", "Action Button: Home"),
        (
            "msoShapeActionButtonInformation",
            "actionButtonInformation",
            "Action Button: Information",
        ),
        ("msoShapeActionButtonMovie", "actionButtonMovie", "Action Button: Movie"),
        ("msoShapeActionButtonReturn", "actionButtonReturn", "Action Button: Return"),
        ("msoShapeActionButtonSound", "actionButtonSound", "Action Button: Sound"),
        ("msoShapeArc", "arc", "Arc"),
        ("msoShapeBalloon", "wedgeRoundRectCallout", "Rounded Rectangular Callout"),
        ...
        ("msoShapeCurvedRightArrow", "curvedRightArrow", "Curved Right Arrow"),
        ...
        ("msoShapeFlowchartAlternateProcess", "flowChartAlternateProcess", "Alternate process"),
        ...
        ("msoShapeFlowchartDirectAccessStorage", "flowChartMagneticDrum", "Direct Access Storage"),
        ...
        ("msoShapeFlowchartInternalStorage", "flowChartInternalStorage", "Internal Storage"),
        ("msoShapeFlowchartMagneticDisk", "flowChartMagneticDisk", "Magnetic Disk"),
        ("msoShapeFlowchartManualInput", "flowChartManualInput", "Manual Input"),
        ("msoShapeFlowchartManualOperation", "flowChartManualOperation", "Manual Operation"),
        ("msoShapeFlowchartMerge", "flowChartMerge", "Merge"),
        ("msoShapeFlowchartMultidocument", "flowChartMultidocument", "Multidocument"),
        ("msoShapeFlowchartOfflineStorage", "flowChartOfflineStorage", "Offline Storage"),
        ("msoShapeFlowchartOffpageConnector", "flowChartOffpageConnector", "Off-page Connector"),
        ("msoShapeFlowchartOr", "flowChartOr", "Or"),
        ("msoShapeFlowchartPredefinedProcess", "flowChartPredefinedProcess", "Predefined Process"),
        ("msoShapeFlowchartPreparation", "flowChartPreparation", "Preparation"),
        ("msoShapeFlowchartProcess", "flowChartProcess", "Process"),
        ("msoShapeFlowchartPunchedTape", "flowChartPunchedTape", "Punched Tape"),
        (
            "msoShapeFlowchartSequentialAccessStorage",
        ...
        ("msoShapeFlowchartStoredData", "flowChartOnlineStorage", "Stored Data"),
        ("msoShapeFlowchartSummingJunction", "flowChartSummingJunction", "Summing Junction"),
        ...
        ("msoShapeHorizontalScroll", "horizontalScroll", "Horizontal Scroll"),
        ("msoShapeIsoscelesTriangle", "triangle", "Isosceles Triangle"),
        ("msoShapeLeftArrow", "leftArrow", "Left Arrow"),
        ("msoShapeLeftArrowCallout", "leftArrowCallout", "Left Arrow Callout"),
        ("msoShapeLeftBrace", "leftBrace", "Left Brace"),
        ("msoShapeLeftBracket", "leftBracket", "Left Bracket"),
        ("msoShapeLeftCircularArrow", "leftCircularArrow", "Left Circular Arrow"),
        ("msoShapeLeftRightArrow", "leftRightArrow", "Left-Right Arrow"),
        ("msoShapeLeftRightArrowCallout", "leftRightArrowCallout", "Left-Right Arrow Callout"),
        ("msoShapeLeftRightCircularArrow", "leftRightCircularArrow", "Left Right Circular Arrow"),
        ("msoShapeLeftRightRibbon", "leftRightRibbon", "Left Right Ribbon"),
        ("msoShapeLeftRightUpArrow", "leftRightUpArrow", "Left-Right-Up Arrow"),
        ...
        ("msoShapeLineCallout1AccentBar", "accentCallout1", "Line Callout 1 (Accent Bar)"),
        (
            "msoShapeLineCallout1BorderandAccentBar",
            "accentBorderCallout1",
            "Line Callout 1 (Border and Accent Bar)",
        ),
        ("msoShapeLineCallout1NoBorder", "callout1", "Line Callout 1 (No Border)"),
        ("msoShapeLineCallout2", "borderCallout2", "Line Callout 2"),
        ("msoShapeLineCallout2AccentBar", "accentCallout2", "Line Callout 2 (Accent Bar)"),
        (
            "msoShapeLineCallout2BorderandAccentBar",
            "accentBorderCallout2",
            "Line Callout 2 (Border and Accent Bar)",
        ),
        ("msoShapeLineCallout2NoBorder", "callout2", "Line Callout 2 (No Border)"),
        ("msoShapeLineCallout3", "borderCallout3", "Line Callout 3"),
        ("msoShapeLineCallout3AccentBar", "accentCallout3", "Line Callout 3 (Accent Bar)"),
        (
            "msoShapeLineCallout3BorderandAccentBar",
            "accentBorderCallout3",
            "Line Callout 3 (Border and Accent Bar)",
        ),
        ("msoShapeLineCallout3NoBorder", "callout3", "Line Callout 3 (No Border)"),
        ("msoShapeLineCallout4", "borderCallout3", "Line Callout 3"),
        ("msoShapeLineCallout4AccentBar", "accentCallout3", "Line Callout 3 (Accent Bar)"),
        (
            "msoShapeLineCallout4BorderandAccentBar",
            "accentBorderCallout3",
            "Line Callout 3 (Border and Accent Bar)",
        ),
        ("msoShapeLineCallout4NoBorder", "callout3", "Line Callout 3 (No Border)"),
        ...
        ("msoShapeNonIsoscelesTrapezoid", "nonIsoscelesTrapezoid", "Non-isosceles Trapezoid"),
        ("msoShapeNotchedRightArrow", "notchedRightArrow", "Notched Right Arrow"),
        ...
        ("msoShapeQuadArrowCallout", "quadArrowCallout", "Quad Arrow Callout"),
        ("msoShapeRectangle", "rect", "Rectangle"),
        ("msoShapeRectangularCallout", "wedgeRectCallout", "Rectangular Callout"),
        ("msoShapeRegularPentagon", "pentagon", "Regular Pentagon"),
        ("msoShapeRightArrow", "rightArrow", "Right Arrow"),
        ("msoShapeRightArrowCallout", "rightArrowCallout", "Right Arrow Callout"),
        ...
        ("msoShapeRound1Rectangle", "round1Rect", "Round Single Corner Rectangle"),
        ("msoShapeRound2DiagRectangle", "round2DiagRect", "Round Diagonal Corner Rectangle"),
        ("msoShapeRound2SameRectangle", "round2SameRect", "Round Same Side Corner Rectangle"),
        ...
        ("msoShapeSnip1Rectangle", "snip1Rect", "Snip Single Corner Rectangle"),
        ("msoShapeSnip2DiagRectangle", "snip2DiagRect", "Snip Diagonal Corner Rectangle"),
        ("msoShapeSnip2SameRectangle", "snip2SameRect", "Snip Same Side Corner Rectangle"),
        ("msoShapeSnipRoundRectangle", "snipRoundRect", "Snip and Round Single Corner Rectangle"),
        ("msoShapeSquareTabs", "squareTabs", "Square Tabs"),
        ("msoShapeStripedRightArrow", "stripedRightArrow", "Striped Right Arrow"),
        ("msoShapeSun", "sun", "Sun"),
        ...
        ("msoShapeUpDownArrowCallout", "upDownArrowCallout", "Up-Down Arrow Callout"),
...
def const_name_map():
    ...
    return (
        ...
        ("msoShapeActionButtonBackorPrevious", "ACTION_BUTTON_BACK_OR_PREVIOUS"),
        ...
        ("msoShapeActionButtonForwardorNext", "ACTION_BUTTON_FORWARD_OR_NEXT"),
        ...
        ("msoShapeFlowchartDirectAccessStorage", "FLOWCHART_DIRECT_ACCESS_STORAGE"),
        ...
        ("msoShapeFlowchartPredefinedProcess", "FLOWCHART_PREDEFINED_PROCESS"),
        ...
        ("msoShapeFlowchartSequentialAccessStorage", "FLOWCHART_SEQUENTIAL_ACCESS_STORAGE"),
        ...
        ("msoShapeLineCallout1BorderandAccentBar", "LINE_CALLOUT_1_BORDER_AND_ACCENT_BAR"),
        ...
        ("msoShapeLineCallout2BorderandAccentBar", "LINE_CALLOUT_2_BORDER_AND_ACCENT_BAR"),
        ...
        ("msoShapeLineCallout3BorderandAccentBar", "LINE_CALLOUT_3_BORDER_AND_ACCENT_BAR"),
        ...
        ("msoShapeLineCallout4BorderandAccentBar", "LINE_CALLOUT_4_BORDER_AND_ACCENT_BAR"),
